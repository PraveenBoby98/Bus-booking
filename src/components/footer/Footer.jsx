      ...
      <div className="grid grid-cols-5 gap-5">
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            ...
            <li>
              <Link to="/contactus" className='hover:text-violet-600 ease-in-out duration-300'>Contact Us</Link>
            </li>
            <li>
              <Link to="/privacy" className='hover:text-violet-600 ease-in-out duration-300'>Privacy Policy</Link>
            </li>
            <li>
              <Link to="/termscondtion" className='hover:text-violet-600 ease-in-out duration-300'>Terms and Conditions</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            <li>
              <Link to="/safetyguarantee" className='hover:text-violet-600 ease-in-out duration-300'>Safety Guarantee</Link>
            </li>
            <li>
              <Link to="/faqsupport" className='hover:text-violet-600 ease-in-out duration-300'>FAQ & Support</Link>
            </li>
            <li>
              <Link to="/bus" className='hover:text-violet-600 ease-in-out duration-300'>Luxury Buses</Link>
            </li>
            <li>
              <Link to="/enoughfacilities" className='hover:text-violet-600 ease-in-out duration-300'>Enough Facilities</Link>
            </li>
          </ul>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-x-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-neutral-700 dark:text-neutral-400">
                  Anu Chowk ,Hamirpur,Himachal Pradesh
                </p>
              </div>
            </div>
